...
export default function manifest(): MetadataRoute.Manifest {
	return {
		...
		short_name: 'DecoDar',
		description:
			'Discover our world of holistic care. Innovative, creative and innovative, get tips and articles to improve your personality. Join us now and start a journey towards a unique experience with Dorian Care.',
		theme_color: '#000000',
